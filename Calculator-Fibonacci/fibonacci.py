...
Cursor.execute( "CREATE TABLE Calculator.fibonacci (metric varchar(255))")

print("fibonacci table is created")
...
class MyWebService(object):
   ...
   def fibonacci(self):
        ...
        if cherrypy.request.method == 'POST':
              ...
              Cursor = dataBase.cursor()
              sql = "INSERT INTO Calculator.fibonacci (metric) VALUES (%s)"
              values = (metric,)
